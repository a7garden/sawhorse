...
export default function WorkflowStudioPage() {
  ...
  useEffect(() => {
    // Watcher and focus bursts each re-read catalog, drafts, and the whole snapshot;
    // coalesce them into one load. The loadSequence race guard still discards stale reads.
