...
- `work/<id>/work.md`: task metadata, dependency IDs, dates, stage, status, decision history.
- Sibling `intent.md`, `spec.md`, `plan.md`, `verification.md`, `release.md`, `learning.md`: the artifact chain.
- `calendar/<id>.md`: events. `runs/<id>.md`: host-managed execution records.
