---
name: setup
description: Diagnose the Sawhorse SI pack's vault path, document assets, agent tools, and journal hook. Use for setup or troubleshooting of these features.
---
...
- SI 자산: `${CLAUDE_PLUGIN_ROOT}/packs/si/pack.json`의 `workspace` 선언과 비교해 없는 파일을 보고한다. 필요한 경우 `/sawhorse:init-vault`로 준비한다.
